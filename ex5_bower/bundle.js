...
},{"./template.hbs":2,"countUp":13,"jquery":3,"underscore":12}],2:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
  var helper, functionType="function", helperMissing=helpers.helperMissing, escapeExpression=this.escapeExpression;
  return "<h1>A TERSE INTRODUCTION TO BROWSERIFY</h1>\n<h2>Source Transforms</h2>\n<h3>HBSFY</h3>\n\n<br/>\n\n<code id=\"result\">Sum : "
    + escapeExpression(((helper = (helper = helpers.sum || (depth0 != null ? depth0.sum : depth0)) != null ? helper : helperMissing),(typeof helper === functionType ? helper.call(depth0, {"name":"sum","hash":{},"data":data}) : helper)))
    + "</code>\n";
},"useData":true});
